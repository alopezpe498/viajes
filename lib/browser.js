 ...
 * suelta. Pero si alguno se colgara antes de llegar ahí, ese dominio se quedaría
 * cerrado y el viaje perdería sus búsquedas en silencio.
 */
...
export async function abrirNavegador(opciones = {}) {
  ...
  const alarma = setTimeout(() => {
    console.warn(
      `[browser] La plaza de ${dominio} lleva ${TOPE_DE_PLAZA_MS / 60000} min tomada: la suelto a la fuerza.`
    );
    soltar();
  }, TOPE_DE_PLAZA_MS);
